                    ...
                    <section class="p-hero p-hero--page p-menu">
                        ...
                        <?php else : //サムネイルが設定されていなければデフォルト画像を表示する?>
                            <picture class="p-menu__img">
                                <source media="(min-width: 960px)" srcset="<?php echo get_template_directory_uri(); ?>/img/hero_bg4.png">
                                <source media="(min-width: 560px)" srcset="<?php echo get_template_directory_uri(); ?>/img/hero_bg4-md.png">
                                <img src="<?php echo get_template_directory_uri(); ?>/img/hero_bg4-sm.png">
                            </picture>
                        <?php endif; ?>
