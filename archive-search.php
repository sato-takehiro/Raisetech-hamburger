<?php get_header(); //header.phpを読み込むテンプレートタグ（インクルードタグ）?>
                    ...
                    while( have_posts() ) :
                        ...
                        <section class="p-menu l-contents" id="post-<?php the_ID(); //投稿ID?>" <?php post_class(); //生成するページによってclassを付与する?>>
                            ...
                            <div class="p-menu__contents">
                                ...
                                <p class="p-menu__description"><?php the_content('<a href=" the_permalink(); " class="c-button u-button">詳しく見る</a>');//投稿本文の一部のプレビュー、引数で「さらに...」を「詳しく見る」に置き換える ?></p>
                            </div>
                        </section>
                    <?php endwhile;
                else :
            ...
            <div class="c-pagenation pd0 pd0-md l-contents">
